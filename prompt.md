...
Phase G.1 (Smart Defaults + --bootstrap):
...
CRITICAL: Complete phases sequentially (Phase A -> B -> C -> D -> E -> F -> G.1 -> G.2 -> G.3 -> G.4). Do NOT skip ahead to a later phase while earlier phases have unchecked tasks.
